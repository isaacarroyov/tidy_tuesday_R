...
df_combinations_bed_baths_nhoods %>%
  ...
  labs(title = "Most published neighbourhoods in Craigslist: Their rental prices and number of beds + baths.",
       subtitle = "The data visualization showcases the distribution of rental prices according to the number of beds + baths in each neighbourhood.<br><br>The dots represent an observation, and every combination of the number of beds and number of baths is colour-encoded. The black line is the median price of the rest of the dataset - where the number of beds and baths were specified - which is $2,000.<br><br>In order to get a better view of the rental prices, the x-axis had to be scaled to logarithm base 10. <br><br>Observations:<br>• The median rental price of 4-bed properties are higher in all neighbourhoods.<br>• Almost all IQRs of 1-bed properties lay beneath the median rental price (left side of the black line).<br>• According to the data, the neighbourhood with the highest median rental price is san jose south ($1,968), and belmont / san carlos has the lowest median rental price ($1,400).",
