...
df %>%
  ...
  labs(title = "European flights and the consequences due to COVID-19",
  ...
  theme(
    ...
    # Title
    plot.title = element_textbox_simple(colour = "black", face = "bold", family = "titleFont", lineheight = 0.1, size = 93, margin = margin(5,15,0,5)),
